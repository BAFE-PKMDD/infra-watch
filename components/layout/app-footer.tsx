      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/faq" className="text-slate-400 hover:text-accent transition-colors">
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/data-deletion" className="text-slate-400 hover:text-accent transition-colors">
              {t("footer.deletion")}
            </Link>
            <Link href="/terms-of-service" className="text-slate-400 hover:text-accent transition-colors">
              {t("footer.terms")}
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
            ...
            <div>
              ...
              <div className="flex flex-col gap-1 text-sm">
                <a href="https://www.gov.ph" className="text-primary hover:text-primary/80 dark:text-primary" target="_blank" rel="noreferrer noopener">
                  GOV.PH
                </a>
                <a href="https://data.gov.ph" className="text-primary hover:text-primary/80 dark:text-primary" target="_blank" rel="noreferrer noopener">
                  Open Data Portal
                </a>
                <a href="https://www.officialgazette.gov.ph" className="text-primary hover:text-primary/80 dark:text-primary" target="_blank" rel="noreferrer noopener">
                  Official Gazette
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-1 text-sm">
                ...
                <a href="https://ovp.gov.ph/" className="text-primary hover:text-primary/80 dark:text-primary" target="_blank" rel="noreferrer noopener">
                  Office of the Vice President
                </a>
                <a href="https://www.senate.gov.ph/" className="text-primary hover:text-primary/80 dark:text-primary" target="_blank" rel="noreferrer noopener">
                  Senate of the Philippines
                </a>
                <a href="https://www.congress.gov.ph/" className="text-primary hover:text-primary/80 dark:text-primary" target="_blank" rel="noreferrer noopener">
                  House of the Representatives
                </a>
                <a href="https://sc.judiciary.gov.ph/" className="text-primary hover:text-primary/80 dark:text-primary" target="_blank" rel="noreferrer noopener">
                  Supreme Court
                </a>
                <a href="https://ca.judiciary.gov.ph/" className="text-primary hover:text-primary/80 dark:text-primary" target="_blank" rel="noreferrer noopener">
                  Court of Appeals
                </a>
                <a href="https://sb.judiciary.gov.ph/" className="text-primary hover:text-primary/80 dark:text-primary" target="_blank" rel="noreferrer noopener">
                  Sandiganbayan
                </a>
              </div>
            </div>
