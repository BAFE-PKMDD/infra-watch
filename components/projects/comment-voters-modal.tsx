...
import { getCommentVoters } from "@/actions/query/feedback-comments.query";
...
interface CommentVotersModalProps {
  commentId: string | null;
  isOpen: boolean;
  onClose: () => void;
}

export function CommentVotersModal({ commentId, isOpen, onClose }: CommentVotersModalProps) {
