  ...
  return (
    <div className="min-w-0">
      <div className="flex items-center gap-1 mb-0.5">
        ...
        <Tooltip>
          <TooltipTrigger>
            <HelpCircle className="w-3 h-3 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 cursor-help transition-colors flex-shrink-0" />
          </TooltipTrigger>
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1 mb-0.5">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="top">
                      <p className="max-w-xs">{t("projectDetail.overview.statusTooltip")}</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1 mb-0.5">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="top">
                      <p className="max-w-xs">{t("projectDetail.overview.locationTooltip")}</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <button
                  onClick={onShowOnMap}
                  className="flex items-center gap-2 text-sm font-medium text-slate-900 dark:text-white hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors group cursor-pointer"
                >
                ...
                <div>
                  <div className="flex items-center gap-1 mb-1.5">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent side="top">
                        <p className="max-w-xs">{t("projectDetail.overview.commoditiesTooltip")}</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
            ...
            {/* ── Card 6: Additional Details (conditional) ── */}
                  ...
                  <div>
                    <div className="flex items-center gap-1 mb-0.5">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="top">
                          <p className="max-w-xs">{t("projectDetail.overview.descriptionTooltip")}</p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
